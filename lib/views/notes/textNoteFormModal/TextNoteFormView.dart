...
class TextNoteFormView extends StatefulWidget {
  final DatabaseNote? existingTextNote;
  bool get isEditMode => existingTextNote != null;

  const TextNoteFormView({super.key, required this.existingTextNote});
  @override
  State<TextNoteFormView> createState() => _TextNoteFormViewState();
}

class _TextNoteFormViewState extends State<TextNoteFormView> {
          ...
          return Padding(
            ...
            child: TextButton(
              ...
              child: Icon(
                icon,
                size: 24,
                color: const Color.fromARGB(255, 251, 96, 30),
              ),
            ),
          );
        },
